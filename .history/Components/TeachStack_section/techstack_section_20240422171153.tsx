...
export default function TechStackSection() {
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 aspect-square justify-center items-center gap-3 mx-5 my-3">
        {uniqueTechStack.map((tech, index) => (
          <div
            key={index}
            className="bg-blue-50 w-25 h-auto flex flex-col items-center justify-center p-5 rounded-lg shadow-md"
          >
            {
              <div>
