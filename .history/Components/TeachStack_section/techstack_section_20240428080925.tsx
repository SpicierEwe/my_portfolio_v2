    ...
    <div>
      ...
      <div className="grid grid-cols-2 px-5 sm:grid-cols-3 max-w-3xl mx-auto aspect-square justify-center items-center gap-5 md:gap-x-7 my-3 mt-14 mb-16">
        {uniqueTechStack.map((tech, index) => (
          ...
          >
            <div className="bg-white rounded-full p-3 border border-secondary-color overflow-hidden drop-shadow animate-wiggle hover:scale-105 transition-transform duration-300 ease-in-out ">
