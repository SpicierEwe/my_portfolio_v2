...
export default function TechStackSection() {
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 aspect-square justify-center items-center gap-5 mx-5 my-3 mt-14 mb-16">
        {uniqueTechStack.map((tech, index) => (
          <div
            key={index}
            className="bg-gray border-50 w-25 h-auto flex flex-col items-center justify-center p-5 rounded-lg"
          >
