...
function Redirection(props) {
  ...
  const classNames: string =
    "cursor-pointer shadow-md rounded-lg overflow-hidden mb-3 border border-gray-100 hover:bg-gray-100 hover:border-gray-300 transition transform duration-300 ease-in-out group border border-gray-100 ";
