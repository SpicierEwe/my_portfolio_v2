  ...
  return (
    <section id="work">
      ...
      <main>
        {/* projects */}
        <div
          className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-7 mt-14 px-3 md:px-5 py-3  max-w-7xl mx-auto items-start`}
        >
            ...
            (item: any, index: number) => {
              ...
              return (
                <Redirection
                  ...
                  projectId={projectId}
                >
                  <div className="h-48 w-full object-cover rounded-lg">
                    <Image
                      className={`${
                        isNavApps ? "aspect-square object-contain" : ""
                      }
                     group-hover:scale-105 transition-all duration-500 ease-in-out object-cover rounded-lg w-full h-full`}
                      src={imageLink}
                      alt={projectName}
                      height={200}
                      width={200}
