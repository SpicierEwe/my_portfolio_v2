              ...
              (item: any, index: number) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`${
                        isNavUx ? "h-56 w-full object-cover" : ""
                      } border border-gray-100 shadow-sm rounded-lg overflow-hidden group-hover:shadow-lg transition-all duration-500 ease-in-out`}
                    >
                      <Image
                        className={`
