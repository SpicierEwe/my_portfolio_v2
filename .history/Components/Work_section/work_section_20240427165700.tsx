    ...
    <section id="work">
      ...
      <main>
        ...
        {navItems[selectedNavItemIndex] != "mockups" && (
          <div
            className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-7 md:gap-11 mt-14 px-3 md:px-5 py-3  max-w-screen-xl mx-auto`}
          >
...
function Redirection(props) {
  ...
  const classNames: string =
    "cursor-pointer shadow-sm rounded-lg overflow-hidden mb-3 border border-gray-100 hover:bg-gray-100 hover:border-gray-300 transition transform duration-300 ease-in-out group border border-gray-200 border-2 ";
