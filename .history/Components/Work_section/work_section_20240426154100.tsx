            ...
            (item: any, index: number) => {
              ...
              return (
                ...
                >
                  <div
                    className={`${
                      isNavUx ? "h-48 w-full object-cover rounded-lg" : ""
                    }`}
                  >
                    <Image
                      className={`
                      ${isNavApps ? "aspect-square object-contain" : ""}
                      ${isNavUx ? " rounded-lg w-full h-full" : ""}
                     group-hover:scale-105 transition-all duration-500 ease-in-out object-cover`}
                      src={imageLink}
                      alt={projectName}
                      height={200}
                      width={200}
                      layout={ isNavApps?`responsive`}
                    />
                  </div>
