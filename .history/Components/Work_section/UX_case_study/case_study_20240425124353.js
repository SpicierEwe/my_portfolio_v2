      ...
      <div>
        ...
        <div className={styles.aa}>
          ...
          <Image
            ...
            src={data["case_study"]["image_links"]["hero_image"]}
            width={1000}
            height={1000}
            alt="hero image"
            priority={true}
          ...
          <div className={`${styles.container}`}>
            <div
              className={` ${styles.desktop_hero_image_overlay_info_container} `}
            >
              <div
                className={
              ...
              >
                <h2 className={styles.hero_info_title}>PROJECT : </h2>
              ...
              >
                <h2 className={styles.hero_info_title}>ROLE : </h2>
                <p>{data["case_study"]["role"]}</p>
              </div>
              <div
                className={
                  styles.desktop_hero_image_overlay_info_container_sub_flex
              ...
              >
                ...
                <p>{data["case_study"]["project_duration"]}</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className={styles.the_product_flex}>
            ...
            <div className={styles.product_info}>
              ...
              <div className={styles.paragraph_style}>
                {data["case_study"]["project_overview"]["the_product"]}
              </div>
            </div>
            {/* product_image */}
            <Image
              className={styles.product_image}
              src={data["case_study"]["image_links"]["product_image"]}
              width={1000}
              height={1000}
              alt="product image"
            ></Image>
            ...
            <div className={styles.simple_flex}>
              ...
              <div>
                ...
                <div className={styles.goal_style}>
                  {data["case_study"]["project_overview"]["the_goal"]}
                </div>
              </div>
              {/* the problem */}
              <div>
                ...
                <div>
                  {data["case_study"]["project_overview"]["the_problem"].map(
                    (item, index) => {
                      console.log(item);
                      return (
              ...
              <div>
                ...
                <div className={styles.goal_style}>
                  {data["case_study"]["project_overview"]["my_role"]}
                </div>
              </div>
              ...
              <div>
                ...
                <div className={styles.goal_style}>
                  {data["case_study"]["project_overview"]["responsibilities"]}
                </div>
              </div>
            </div>
          </div>
        ...
        <div className={styles.container}>
            ...
            <div className={styles.summary_container}>
              ...
              <p
                ...
                dangerouslySetInnerHTML={{
                  __html: data["case_study"]["user_research"]["summary"],
                }}
              ></p>
            </div>
          </div>
          ...
          <div className={styles.section_padding}>
            <div>
              ...
              <div>
                {data["case_study"]["user_research"]["pain_points"].map(
                  (item, index) => {
                    return (
                      <div key={index}>
        ...
        <div>
            ...
            <div className={styles.container}>
              <div className={styles.personas_container}>
                ...
                <div className={styles.personas_flex}>
                  {data["case_study"]["user_research"]["personas"].map(
                    (persona, index) => {
                      return (
                        <div key={index} className={styles.persona_border}>
                          <div className={styles.single_persona_flex}>
                            <div
                              ...
                              style={{
                                ...
                                border: `0.5em solid ${data["case_study"]["accent_color"]}`,
                              }}
                            ></div>
                          ...
                          <div className={styles.user_interests_container}>
                            ...
                            {/* USER STORY */}
                            <div>
                              <h2 className={styles.user_story_heading}>
                                Story
                              </h2>
          ...
          <Prototype
            ...
            prototype_summary={
              data["case_study"]["prototypes"]["lo_fi_prototype"]["summary"]
            }
            prototype_image_link={
              data["case_study"]["prototypes"]["lo_fi_prototype"][
                "prototype_image_link"
              ]
            }
          ></Prototype>
          ...
          <div className={`${styles.container}`}>
            ...
            <div className={styles.section_heading}>Mockups</div>
            <div>
              {data["case_study"]["mockups"].map((item, index) => {
                return (
                  <div
                    key={index}
                    className={
          ...
          <Prototype
            ...
            prototype_summary={
              data["case_study"]["prototypes"]["hi_fi_prototype"]["summary"]
            }
            prototype_image_link={
              data["case_study"]["prototypes"]["hi_fi_prototype"][
                "prototype_image_link"
              ]
            }
          ></Prototype>
