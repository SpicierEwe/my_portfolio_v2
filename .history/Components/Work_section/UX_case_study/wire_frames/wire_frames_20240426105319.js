          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-5">
              ...
              <div className="flex items-center lg:flex-col">
                ...
                <HiArrowNarrowDown
                  size={21}
                  className="-rotate-90 lg:rotate-0  cursor-pointer hover:translate-x-0.5 hover:lg:translate-y-0.5 lg:hover:scale-0  hover:scale-110 transition-transform duration-200 ease-in-out"
                  onClick={() => {
                    if (
