          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="flex">
                {/* Up arrow */}
                <HiArrowNarrowUp
                  className="-rotate-90 cursor-pointer hover:-translate-x-0.5 hover:scale-110 transition-transform duration-500 ease-in-out"
                  onClick={() => {
                ...
                {/* Down arrow */}
                <HiArrowNarrowDown
                  className="-rotate-90 cursor-pointer hover:translate-x-1 hover:scale-110 transition-transform duration-500 ease-in-out"
                  onClick={() => {
                    if (
