            ...
            {projectData["case_study"]["user_research"]["personas"].map(
              (persona, index) => (
                <div key={index} className="p-3 m-3 shadow border ">
                  <div className="flex flex-col md:flex-row gap-5 justify-around border rounded-md shadow-md p-5 ">
                    {/* iamge contianer */}
                    <div className="overflow-hidden aspect-square rounded-full border border-spacing-6 border-orange-500 w-28 md:w-40 ">
                      <Image
