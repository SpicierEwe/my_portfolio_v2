            ...
            <div className="max-w-screen-xl mx-auto">
              ...
              {projectData["case_study"]["user_research"]["pain_points"].map(
                (item, index) => (
                  <div
                    key={index}
                    className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-x-14 my-5"
                  >
            ...
            {projectData["case_study"]["user_research"]["personas"].map(
              (persona, index) => (
                <div key={index} className="p-3 m-3 shadow border ">
                  <div className="flex flex-col md:flex-row gap-5 justify-evenly items-start md:items-center border rounded-md shadow-md p-5 ">
                    {/* iamge contianer */}
                    <div className="overflow-hidden rounded-full border  border-orange-500 w-28 h-28 md:w-40 md:h-40 flex-2 ">
                      <Image
