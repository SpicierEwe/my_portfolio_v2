  ...
  return (
    <div>
      ...
      <div className="relative">
        ...
        />
        <div
          className="flex flex-col gap-3 mt-5 px-5 md:absolute sm:bottom-0 md:flex-row w-full
        justify-start md:justify-center items-start md:items-center sm:py-5 sm:backdrop-blur-3xlxl sm:text-black xl:text-xl"
        >
