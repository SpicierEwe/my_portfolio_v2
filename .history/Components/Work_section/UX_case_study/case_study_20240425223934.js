    ...
    <div className="overflow-hidden">
      ...
      <div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 md:gap-x-1">
            {projectData["case_study"]["user_research"]["personas"].map(
              (persona, index) => (
                <div key={index} className="p-3 m-3 shadow border ">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 justify-evenly items-start md:items-center border rounded-md shadow-md p-5 ">
                    {/* iamge contianer */}
