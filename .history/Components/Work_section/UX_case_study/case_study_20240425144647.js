  ...
  return (
    <div>
      ...
      <div className="">
        ...
        <div className="grid grid-cols-1 gap-9 mt-14 bg-gray-100">
          <div className="flex flex-col gap-5 shadow border p-3">
            <MdStars size={45} />
            <h3>The Goal</h3>
            <p>{projectData["case_study"]["project_overview"]["the_goal"]}</p>
          </div>
          <div className="flex flex-col gap-5 shadow border">
