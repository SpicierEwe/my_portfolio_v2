    ...
    <div className="overflow-hidden">
      ...
      <div>
        ...
        <div className="px-5 mx-auto">
          ...
          <div>
            <CaseStudyUtils.CaseStudySubSectionTitle title="Pain Points" />
              ...
              (item, index) => (
                ...
                >
                  {Object.keys(item).map((key, index2) => (
                    <div
                      key={index2}
                      className="flex flex-col gap-5 shadow border p-5"
                    >
                      <div className="rounded-full  bg-red-500 w-min px--px-3 py-px-2 shadow ">
