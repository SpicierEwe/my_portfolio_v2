...
import CompetativeAnalysis from "./competative_analysis";
import WireFrames from "./wire_frames";
  ...
  return (
    <div className="overflow-hidden">
      ...
      <div>
        ...
        <div className="bg-gray-100 pt-3 md:pt-0 pb-14 md:pb-9 my-24">
        ...
        <div>
          ...
          <div className="max-w-5xl mx-auto p-5">
            {projectData["case_study"]["mockups"].map((item, index) => {
              const isWebMockup = Object.keys(item)[0].includes("web");
              return (
                <div
                  key={index}
                  className={`grid ${
                    isWebMockup ? "grid-cols-1" : "grid-cols-2"
                  } md:grid-cols-3 lg:grid-cols-4 gap-5 gap-y-16`}
                >
        ...
        {/* Takeaways */}
        <div className="max-w-5xl mx-auto md:text-lg">
          <h2 className="font-bold text-center text-3xl mt-20 md:mt-40 mb-5">
            Takeaways
          </h2>
          <p className=" leading-relaxed md:leading-loose p-5 text-justify md:text-center">
