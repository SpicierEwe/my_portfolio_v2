              ...
              (persona, index) => (
                <div key={index} className="p-3 m-3 shadow border">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5 justify-center">
                    <div className="overflow-hidden aspect-square rounded-full border border-spacing-6 border-orange-500 h-auto w-28 md:w-40 border rounded-md shadow-md p-5 ">
                      <Image
