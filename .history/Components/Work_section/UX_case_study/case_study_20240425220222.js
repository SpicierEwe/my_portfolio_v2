              ...
              (persona, index) => (
                <div key={index} className="p-3 m-3 shadow border">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5 justify-center">
                    <div className="overflow-hidden aspect-square rounded-full border border-spacing-6 border-orange-500 h-auto w-20 md:w-40">
                      <Image
                    ...
                    <div>
                      <h3>
                        {Object.keys(persona["user_info"]).map(
                          (item, index2) => (
                            <div key={index2} className="flex gap-5">
                              <div>
                                {item !== "user_image" &&
                                  `${item
                                    .replace("user_", "")
