    ...
    <div>
      ...
      <div className="relative">
        <Image
          ...
          priority={true}
        />
        <div className="flex flex-col gap-3 mt-5 px-5 sm:absolute sm:bottom-0 sm:flex-row w-full sm:justify-center sm:items-center sm:py-7 sm:backdrop-blur-md sm:text-white">
