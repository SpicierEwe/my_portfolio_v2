  ...
  return (
    <div>
      <div className="mt-14 md:mt-28">
        ...
        <div className="overflow-x-scroll md:mx-auto md:p-11 md:overflow-x-hidden  shadow border mt-11 pl-5 ml-5 mb-9 max-w-min">
          <table className="">
            {/* Table header */}
            ...
            {projectData["case_study"]["competative_analysis"]["table_data"][
              ...
              <tr key={index} className="pt-5 border-r-2">
                {competitors.map((competitor, index2) => (
                  <td key={index2} className="py-3">
                    {/* competetor names */}
                    {index2 === 0 ? (
                      <span>
