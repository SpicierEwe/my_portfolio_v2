  ...
  return (
    <div>
      <div className="mt-14 md:mt-28">
        <div className="pl-5">
          <CaseStudyUtils.CaseStudySectionTitle title="Competative Analysis" />
          <p
        ...
        <div className="overflow-x-scroll md:mx-auto md:p-11 md:overflow-x-hidden  border mt-11 pl-5 ml-5 mb-9 max-w-min shadow-sm">
          <table className="">
            {/* Table header */}
