...
export default function CaseStudyComponent(props) {
  ...
  return (
    <div>
      ...
      <div>
        <h3>The Product</h3>
        <p>{projectData["case_study"]["project_overview"]["the_product"]}</p>
        <Image
      ...
      <Prototype
        ...
        prototype_summary={
          projectData["case_study"]["prototypes"]["lo_fi_prototype"]["summary"]
        }
      ...
      <Prototype
        ...
        prototype_summary={
          projectData["case_study"]["prototypes"]["hi_fi_prototype"]["summary"]
        }
        prototype_image_link={
