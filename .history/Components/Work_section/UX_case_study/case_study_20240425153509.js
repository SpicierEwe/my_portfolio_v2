    ...
    <div>
      ...
      <div className="relative">
        <Image
          ...
          priority={true}
        />
        <div className="flex flex-col gap-3 mt-5 px-5 sm:absolute sm:bottom-0 sm:flex-row w-full sm:justify-evenly sm:items-center sm:py-5 sm:backdrop-blur-3xl sm:text-black xl:text-xl">
