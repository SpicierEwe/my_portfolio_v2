    ...
    <div>
      ...
      <div>
        <div className="m-5">
          ...
          <div className="mt-14 md:mt-36 grid grid-cols-1 gap-5  gap-y-9 md:grid-cols-2 max-w-6xl mx-auto md:text-lg md:gap-x-11 items-center md:leading-loose md:mb-32">
            <div>
