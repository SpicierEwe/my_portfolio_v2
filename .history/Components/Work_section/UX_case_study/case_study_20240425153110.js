    ...
    <div>
      ...
      <div className="relative">
        <Image
          ...
          priority={true}
        />
        <div className="flex flex-col gap-3 mt-5 px-5 sm:absolute sm:bottom-0 sm:flex-row w-full sm:justify-center sm:items-center sm:py-5 sm:backdrop-blur-3xl">
          <div className="sm:flex items-center justify-center">
            <h2 className="sm:font-bold pr-3">PROJECT:</h2>
            <p className="sm:text-xl">{projectData["projectName"]}</p>
          </div>
          <div className="sm:flex items-center justify-center">
            <h2 className="sm:font-bold pr-3">ROLE:</h2>
            <p>{projectData["case_study"]["role"]}</p>
          </div>
          <div className="sm:flex items-center justify-center">
            <h2 className="sm:font-bold pr-3">DURATION:</h2>
