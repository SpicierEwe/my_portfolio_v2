    ...
    <div className="overflow-hidden">
      ...
      <div>
        ...
        <div className="max-w-screen-lg mx-auto">
          <CaseStudyUtils.CaseStudySectionTitle title="Meet the Users" className/>
              ...
              (persona, index) => (
                <div key={index} className="p-3 m-3 shadow border">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5 justify-center">
                    <div className="overflow-hidden aspect-square rounded-full border border-orange-500 h-auto w-20 md:w-40">
                      <Image
