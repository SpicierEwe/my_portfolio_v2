            ...
            {projectData["case_study"]["user_research"]["personas"].map(
              (persona, index) => (
                <div key={index} className="p-3 m-3 shadow border">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5 justify-center w-ful">
                    <div className="overflow-hidden aspect-square rounded-full border border-orange-500 h-20 w-20">
                      <Image
