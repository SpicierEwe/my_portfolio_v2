...
export default function HeroSection() {
  ...
  return (
    <section className="w-screen h-dvh overflow-hidden relative">
      <div className="absolute backdrop-blur-2xl lg:backdropbackdrop-blur-3xl w-screen h-dvh"></div>
      ...
      <div className="h-dvh flex flex-col items-center justify-center absolute inset-0">
        <div className="relative mb-3.5">
          <p className="font-custom_sans tracking-wide text-gray-600 text-md xl:text-lg">
        ...
        {/* Developer name */}
        <h1 className="font-garmond uppercase text-3xl sm:text-5xl md:text-6xl xl:text-7xl xs:whitespace-wrap text-center">
          {devName}
        ...
        {/* Date */}
        <p className="text-xs mt-3">{formatDate()}</p>
      </div>
      {/* Pointer image */}
      <Image
        className="absolute w-auto h-auto bottom-2 right-1/2 animate-bounce cursor-pointer lg:text-2xl"
