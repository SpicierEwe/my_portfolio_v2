...
export default function HeroSection() {
  ...
  return (
    <section className="w-screen h-dvh relative overflow-hidden">
      <div className="absolute backdrop-blur-2xl w-screen h-dvh"></div>
      <div className="absolute w-screen h-dvh -z-10">
        <Image
          className="absolute w-auto h-auto top-1/2 left-10 sm:bg-red-200 animate-levitate"
        ...
        ></Image>
        <Image
          className="absolute w-auto h-auto top-52 right-0 animate-levitate_reverse"
      ...
      <main>
        <div className="h-screen flex flex-col items-center justify-center absolute inset-0">
          <div className="relative mb-3">
            <p className="font-custom_sans tracking-wide text-gray-500 sm:text-5xl">
          ...
          {/* dev name */}
          <h1 className="font-garmond uppercase text-3xl whitespace-nowrap">
