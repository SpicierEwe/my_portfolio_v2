    ...
    <section className="w-screen h-dvh overflow-hidden relative">
      ...
      <div className="h-dvh flex flex-col items-center justify-center absolute inset-0">
        <div className="relative mb-3.5">
          <p className="font-custom_sans tracking-wide text-gray-600 text-md lg:text-xl">
        ...
        {/* Developer name */}
        <h1 className="font-garmond uppercase text-3xl sm:text-5xl md:text-6xl xl:text-7xl xs:whitespace-wrap text-center font-extralight">
          {devName}
