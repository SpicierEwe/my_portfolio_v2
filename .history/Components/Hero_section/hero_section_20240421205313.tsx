  ...
  return (
    <section className="w-screen h-dvh overflow-hidden">
      <main className="relative">
        ...
        <div className="absolute inset-0 w-lvw h-dvh z-10 bg-red-400">
          <Image
            className="absolute w-auto h-auto  left-10 animate-levitate sm:w-72"
          ...
          ></Image>
          <Image
            className="absolute w-auto h-auto top-72 right-0 animate-levitate_reverse sm:w-64"
