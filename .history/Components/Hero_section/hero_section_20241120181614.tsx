...
const FloatingButtons = () => {
  return (
    <div className="absolute top-1/4 right-0 pr-10 p-5 py-3 border bg-gray-50 hover:bg-gray-200   z-[999] rounded-l-xl shadow-md transition-all ease-in-out duration-150 ">
      <a
