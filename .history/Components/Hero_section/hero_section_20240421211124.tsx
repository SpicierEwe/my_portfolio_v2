...
export default function HeroSection() {
  ...
  return (
    <section className="w-screen h-dvh overflow-hidden relative">
      ...
      <div className="absolute inset-0 z-10 h-dvh items-center z-10">
        <div className="flex justify-between items-center w-2/3 m-auto h-full">
          <Image
          ...
          <Image
            className="animate-levitate_reverse"
