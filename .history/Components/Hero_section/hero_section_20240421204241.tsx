  ...
  return (
    <section className="w-screen h-dvh overflow-hidden">
      <main className="relative">
        ...
        <div className="absolute w-screen h-dvh z-10 max-w-screen-lg mt-auto mb-0 ml-auto mr-auto bg-red-400">
          <Image
            className="absolute w-auto h-auto top-1/2 left-10 sm:bg-red-200 animate-levitate sm:w-64"
          ...
          ></Image>
          <Image
            className="absolute w-auto h-auto top-52 right-0 animate-levitate_reverse sm:w-64"
