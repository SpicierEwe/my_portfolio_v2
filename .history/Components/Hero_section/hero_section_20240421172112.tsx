...
export default function HeroSection() {
  ...
  return (
    <section className="w-screen h-dvh relative">
      <div className="absolute backdrop-blur-md  w-screen h-dvh"></div>
      <div className="absolute w-screen h-dvh bg-red-300 -z-10">
        <Image
          className="absolute top-52 left-10 animate-spin"
        ...
        ></Image>
        <Image
          className="absolute top-52 right-0 animate-bounce"
