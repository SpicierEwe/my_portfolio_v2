  ...
  return (
    <section className="pt-12 mb-14 md:mt-12">
      ...
      <div className="flex flex-col justify-center items-center">
        <h1 className="text-3xl md:text-7xl md:font-semibold md:text-gray-800 uppercase tracking-widest text-center">
          {projectNameFunc(projectName + "ssfsf sf ")}
        </h1>
...
function DisplayElements(props: any) {
  ...
  return (
    <div className="md:shadow md:px-11 md:py-7 md:border flex-1">
      ...
      <div
        className={`mt-9 flex flex-col ${
          isTechStack ? "md:gap-y-9 md:flex-row md:mt-11" : ""
