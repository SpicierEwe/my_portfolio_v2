...
export default function Project({ params }) {
  ...
  return (
    <section className="pt-12 mb-14 md:mt-12 bg-gray-100">
      {/* project name */}
      ...
      <main className="max-w-5xl justify-center mx-auto mt-20 md:mt-28 px-6">
        ...
        <div className="mt-14 md:mt-20 flex flex-col  gap-x-9 gap-y-10 mb-9 items-start flex-wrap">
          {/* div 1 */}
          <div>
            <div className="px-0 py-7 md:border ">
          ...
          <div className="flex flex-col md:flex-row gap-9 md:mt-9">
            {/* roles */}
            <DisplayElements
              mainDivClasses=""
              childClasses="mt-10 border p-10 shadow grid grid-cols-1 md:grid-cols-2 gap-x-5 gap-y-7"
              sectionName="Roles"
              info={info}
              dataList={roles}
            />
            ...
            <DisplayElements
              mainDivClasses=""
              childClasses="mt-10 border shadow p-10 grid grid-cols-1 md:grid-cols-2 gap-x-5 gap-y-7"
...
function DisplayElements(props: any) {
  ...
  return (
    <div className={`bg-gray-100 ${mainDivClasses}`}>
