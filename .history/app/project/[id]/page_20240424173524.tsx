  ...
  return (
    <section className="pt-12 mb-14 md:mt-12">
      ...
      <main className="max-w-5xl justify-center mx-auto mt-20 md:mt-28 px-6">
        ...
        <div className="mt-14 md:mt-20 flex flex-col smd:flex-col md:flex-row gap-x-9 gap-y-10 mb-9 items-start">
          {/* div 1 */}
          <div>
          ...
          <DisplayElements
            mainDivClasses="hidden smd:block md:shadow md:px-11 md:py-7 md:border flex-1"
            childClasses="grid grid-cols-1 smd:grid-cols-1 lg:grid-cols-2  gap-x-5 gap-y-7 mt-9"
            sectionName="Roles"
            info={info}
            dataList={roles}
          />
        ...
        {/* visible in mobile */}
        <div className="md:hidden smd:block mt-10">
          <DisplayElements
            mainDivClasses="md:shadow md:px-11 md:py-7 md:border flex-1"
            childClasses="grid grid-cols-2   gap-x-5 gap-y-7 mt-9"
            sectionName="Roles"
            info={info}
            dataList={roles}
          />
