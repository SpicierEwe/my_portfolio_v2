  ...
  return (
    <section className="pt-12 mb-14 md:mt-12">
      ...
      <main className="max-w-5xl justify-center mx-auto mt-20 md:mt-28 px-6">
        ...
        <div className="mt-14 md:mt-20 flex flex-col md:flex-row gap-x-9 gap-y-10 mb-9 items-start">
          {/* div 1 */}
          <div>
...
function DisplayElements(props: any) {
  ...
  const isRoles = sectionName === "Roles";
  return (
    <div className="md:shadow md:px-11 md:py-7 md:border flex-1">
      ...
      <div
        className={`mt-9 grid grid-cols-1 md:grid-cols-2 ${
          isRoles ? "grid-cols-1 lg:grid-cols-1 xl:grid-cols-2" : ""
        }
