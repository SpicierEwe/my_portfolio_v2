...
export default function Project({ params }) {
  ...
  return (
    <section className="pt-12 mb-14 md:mt-12">
      ...
      {/* ============= */}
      <main className="max-w-4xl justify-center mx-auto mt-20 md:mt-28 px-6">
        <h2 className="text-center text-xl tracking-wide">ABOUT</h2>
        <div className="mt-14 md:mt-20 grid grid-cols-1 md:grid-cols-2 gap-x-9 gap-y-10 mb-9">
          {/* div 1 */}
          <div className="md:shadow md:px-5 md:py-7 md:border">
            <h4 className="text-md font-bold text-gray-600 grow">Summary</h4>
...
function DisplayElements(props: any) {
  ...
  return (
    <div className="md:shadow md:px-11 md:py-7 md:border">
...
function projectNameFunc(name: string): JSX.Element {
  ...
  return (
    <p>
      {restOfString}
      <span className="text-secondary-color">{lastThirtyPercent}</span>
    </p>
  );
}
