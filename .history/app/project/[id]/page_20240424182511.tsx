    ...
    <section className="pt-12 mb-14 md:mt-12">
      ...
      <main className="max-w-5xl justify-center mx-auto mt-20 md:mt-28 px-6">
        ...
        <div className="mt-14 md:mt-20 flex flex-col  gap-x-9 gap-y-10 mb-9 items-start flex-wrap">
          ...
          <div className="flex flex-col md:flex-row gap-9 md:mt-9 max-[887px]:bg-red-900">
            {/* roles */}
            <DisplayElements
              mainDivClasses=""
            ...
            <DisplayElements
              mainDivClasses=""
              childClasses="mt-10 border shadow p-10 grid grid-cols-1 md:grid-cols-1 max-[887px]:bg-red-900 gap-x-5 gap-y-7"
