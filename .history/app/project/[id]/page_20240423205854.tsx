  ...
  return (
    <section className="pt-12 mb-14">
      ...
      <main className="max-w-screen-lg justify-center mx-auto">
        <div className="mt-16 mx-6 flex flex-col md:flex-row gap-x-9 items-start gap-y-10">
          {/* div 1 */}
          <div className="lg:shadow lg:px-5 lg:py-7">
          ...
          <div className="flex flex-col lg:flex-row gap-x-5 items-start gap-y-10">
...
function DisplayElements(props: any) {
  ...
  return (
    <div className="lg:shadow lg:px-11 lg:py-5">
