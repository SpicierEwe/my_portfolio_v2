  ...
  return (
    <section className="pt-12 mb-14 md:mt-12">
      ...
      <div className="mt-16 px-5 mx-auto max-w-5xl md:mt-36 gap-x-3">
        {/* top website bar */}
        <div className="flex px-3 py-2 border gap-x-2 mb-1 items-center justify-between">
          ...
          <div className="flex bg-gray-200 rounded px-2 py-0.5 items-center gap-x-2">
            {getIcon("lock", "rounded-full p-1 bg-white")}

            <input
              value={link}
              type="text"
              className="bg-gray-200 w-min focus:outline-none"
