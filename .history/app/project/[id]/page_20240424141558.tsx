  ...
  return (
    <section className="pt-12 mb-14 md:mt-12">
      ...
      <div className="flex flex-col justify-center items-center">
        <h1 className="text-3xl md:text-7xl md:font-semibold md:text-gray-800 uppercase tracking-tight">
      ...
      {/* ============= */}
      <main className="max-w-4xl justify-center mx-auto mt-28">
        <h2 className="text-center text-xl tracking-wide">ABOUT</h2>
        <div className="mt-14 md:mt-20 mx-6 flex flex-col md:flex-row gap-x-9 gap-y-10 flex-wrap">
          {/* div 1 */}
          <div className="md:shadow md:px-5 md:py-7 md:border">
...
function DisplayElements(props: any) {
  ...
  return (
    <div className="md:shadow md:px-11 md:py-5 md:border">
...
function projectNameFunc(name: string): string {
  const nameArr1 = name.slice(0, 1);
  const nameArr2 = name.slice(0, -3);
  const nameArr = nameArr1 + nameArr2;
  return (
    <p>
      {nameArr2} <span className="text-red-900"></span>
    </p>
  );
}
