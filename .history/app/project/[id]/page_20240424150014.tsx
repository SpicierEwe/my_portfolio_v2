  ...
  return (
    <section className="pt-12 mb-14 md:mt-12">
      ...
      <main className="max-w-4xl justify-center mx-auto mt-20 md:mt-28 px-6">
        ...
        <div className="mt-14 md:mt-20 flex flex-col md:flex-row gap-x-9 gap-y-10 mb-9">
          {/* div 1 */}
...
function DisplayElements(props: any) {
  ...
  return (
    <div className="md:shadow md:px-14 md:py-7 md:border">
      <div className="flex gap-x-5 items-center shadow w-min px-3 py-2 rounded-full">
