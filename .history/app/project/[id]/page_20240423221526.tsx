...
export default function Project({ params }) {
  ...
  return (
    <section className="pt-12 mb-14 md:mt-12">
      ...
      {/* project image */}
      <div className="mt-16 px-5 mx-auto max-w-5xl md:mt-36 gap-x-3 justify-evenly">
        <div className="flex px-3 py-2 border gap-x-2 mb-1 items-center">
          ...
          <div className="">
            <input
              type="text "
              className="bg-gray-200 rounded-md px-5"
