      ...
      <main className="max-w-5xl justify-center mx-auto mt-20 md:mt-28 px-6">
        ...
        <div className="mt-14 md:mt-20 flex flex-col  gap-x-9 gap-y-10 mb-9 items-start flex-wrap">
          ...
          <div className="flex flex-col">
            ...
            <DisplayElements
              mainDivClasses=""
              childClasses="mt-10 md:mt-0 grid grid-cols-1 md:grid-cols-2 gap-x-5 gap-y-7"
              sectionName="Roles"
              info={info}
              dataList={roles}
            />
            ...
            <DisplayElements
              ...
              childClasses="mt-10 md:mt-20 md:mt-0 grid grid-cols-1 md:grid-cols-2 gap-x-5 gap-y-7"
