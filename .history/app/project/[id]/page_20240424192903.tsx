      ...
      <main className="max-w-5xl justify-center mx-auto mt-20 md:mt-28 px-6">
        ...
        <div className="mt-14 md:mt-20 flex flex-col  gap-x-9 gap-y-10 mb-9 items-start flex-wrap">
          ...
          <div className="w-full flex flex-col sm:flex-row gap-9 gap-y-16 md:mt-9">
            ...
            <DisplayElements
              mainDivClasses=""
              childClasses="mt-10 border p-10 shadow grid sm:grid-cols-2 md:grid-cols-2 gap-x-5 gap-y-7"
              sectionName="Roles"
              info={info}
              dataList={roles}
            />
            ...
            <DisplayElements
              mainDivClasses=""
              childClasses="mt-10 border shadow p-10 grid xs:grid-cols-2 gap-x-5 gap-y-7"
