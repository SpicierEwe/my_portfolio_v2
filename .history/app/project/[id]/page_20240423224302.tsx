      ...
      <div className="mt-16 px-5 mx-auto max-w-5xl md:mt-36 gap-x-3">
        ...
        <div className="flex px-3 py-2 border gap-x-2 mb-1 items-center justify-between overflow-hidden">
          <div className="flex gap-x-2">
            <div className=" w-2 h-2 md:w-4 rounded-full bg-red-500"></div>
            <div className=" w-2 h-2 md:w-4  rounded-full bg-orange-500"></div>
            <div className=" w-2 h-2 md:w-4 rounded-full bg-green-500"></div>
          </div>
          {/* dummy browser search bar */}
          <div className="flex bg-gray-200 rounded-full px-2 py-0.5 items-center gap-x-2">
            {getIcon(
              "lock",
              " w-2 h-2 md:w-6 md:h-6 rounded-full p-0.5 md:p-1 bg-white"
            )}

            <input
              value={link}
              type="text"
              className="bg-gray-200 w-max focus:outline-none text-xs md:text-lg"
