...
export default function Project({ params }) {
  ...
  return (
    <section className="pt-12 mb-14 md:mt-12">
      ...
      {/* project image */}
      <div className="mt-16 px-5 mx-auto max-w-5xl  md:mt-36">
        <div>
          <MdWork className="mx-auto w-7 h-7 text-gray-600" />
          <h3 className="text-center text-gray-600">Project Image</h3>
        </div>
        <Image
