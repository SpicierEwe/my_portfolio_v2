      ...
      <div className={`${childClasses}`}>
        {dataList.map((tech: string, index: number) => (
          <div key={index} className="flex gap-5 items-center group">
            <div className="shadow-inner bg-gray-50 border rounded-full p-2 transition-all duration-200 ease-in-out">
              <div className="group-hover:scale-150 transition-all duration-200 ease-in-out">
