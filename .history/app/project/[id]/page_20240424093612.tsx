...
export default function Project({ params }) {
  ...
  return (
    <section className="pt-12 mb-14 md:mt-12">
      ...
      {/* ============= */}
      <main className="max-w-4xl md:5xl justify-center mx-auto">
        {/* <div className="mt-16 mx-6 flex flex-col md:flex-row gap-x-9  gap-y-10 flex-wrap"> */}
        <div className="mt-16 mx-6 flex flex-col md:grid md:grid-cols-2 md:flex-wrap gap-x-9  gap-y-10 flex-wrap">
          {/* div 1 */}
