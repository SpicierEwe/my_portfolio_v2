    ...
    <section className="pt-12 mb-14 md:pt-24">
      ...
      <div className="mt-16 px-5 mx-auto max-w-5xl md:mt-36 gap-x-3">
        ...
        <a href={link} target="_blank">
          <Image
            className="mx-auto shadow-md border border-gray-300 rounded-md hover:translate-y-2 hover:scale-105  transition-transform duration-500 ease-in-out cursor-pointer"
            src={imageLink}
            width={2000}
            height={2000}
