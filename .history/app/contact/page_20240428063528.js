    ...
    <div className="max-w-screen-xl  mx-auto">
      ...
      <div className="flex flex-col gap-5   mt-14 mx-11 md:w-fit   md:mx-auto">
        <a
          ...
          target="_blank"
          className=" flex xm:flex-col justify-start md:justify-center items-center bg-blue-50 border border-brand-color hover:bg-brand-color hover:text-white group gap-5 px-8 py-3 rounded-full shadow transition-all duration-300 ease-in-out cursor-pointer"
        >
          <MdEmail
            size={53}
