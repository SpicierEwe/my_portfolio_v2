        ...
        <div className="flex flex-wrap p-10 gap-9 items-center justify-center">
          {a.map((item) => {
            return (
              <p
                key={item}
                className="font-bold shadow bg-[#0093E9] bg-gradient-to-r from-[#0093E9] to-[#80D0C7] text-white p-3 rounded-lg text-center w-52 md:w-72 transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-lg cursor-pointer"
              >
                {item}
                <br />
              </p>
