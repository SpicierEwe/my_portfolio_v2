...
export default function AboutPage() {
  return (
    <div className="max-w-screen-xl mx-auto">
      <h1 className="text-center text-5xl font-bold md:text-7xl mt-14 mb-5 text-[#025a4e] font-garmond">
        I&apos;m Hammad.
      </h1>
      <div className="flex flex-col mt-11 p-5 md:flex-row items-center gap-x-7">
        <h1 className="text-5xl font-bold text-center text-secondary-color md:text-7xl w-full">
          About me
        </h1>
        <p className="mt-9 bg-[#edf5fa] p-5 shadow-md rounded-lg md:p-11">
