...
export default function AboutPage() {
  return (
    <div className="max-w-screen-lg mx-auto">
      <div className="flex flex-col mt-11 p-5 md:flex-row justify-center items-center">
        <h1 className="text-5xl font-bold text-center text-secondary-color md:text-7xl flex-2">
          About me
        </h1>
