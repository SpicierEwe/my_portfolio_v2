    ...
    <div className="max-w-screen-xl mx-auto">
      ...
      <div className="flex flex-col mt-11 md:mt-20 py-11 px-5 gap-11  md:flex-row items-center gap-x-7  bg-[url('/images/bgs/about_bg.svg')]">
        ...
        <p className="shadow-md rounded-lg  bg-white p-5 md:p-9">
          Hi, I&amps;m Hammad Bin Tayyab, I&amps;m a resident of a beautiful
          city of India called Lucknow where I&amps;ve spent most of my life
          till now.
          <br />
          <br />
          I&amps;ve completed my intermeidates from S.T. Fidelis College and
          currently pursuing my Bachelors in Computer Applications at Integral
          University, Lucknow.
          <br />
          <br />I love designing and creating! I&amps;ve previously worked on a
          ...
          of my Portfolio.
          <br />
          <br /> When I&amps;m not designing or developing, you can find me
