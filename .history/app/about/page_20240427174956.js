...
export default function AboutPage() {
  return (
    <div className="max-w-screen-xl mx-auto">
      ...
      <div className="flex flex-col mt-11 p-5 md:flex-row items-center gap-x-7 bg-[#edf5fa] py-11 md:py-0">
        <h1 className="text-5xl font-bold text-center text-secondary-color md:text-7xl w-full">
          About me
        </h1>
        <p className="mt-9  p-5 shadow-md rounded-lg md:p-11 bg-white">
