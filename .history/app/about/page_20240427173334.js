    ...
    <div className="">
      <div className="flex flex-col mt-11 p-5">
        ...
        <p className="mt-9 bg-red-50 p-5 shadow rounded-md">
          ...
          <Link href={"/#work"} className="font-bold mx-5">
            Work
          </Link>
          Section of my Portfolio. When I'm not designing or developing, you can
          find me exploring new things and enjoying life.
        </p>
      </div>
    </div>
  );
