...
export default function AboutPage() {
  return (
    <div className="max-w-screen-xl mx-auto">
      ...
      <div className="flex flex-col mt-11 md:mt-16 py-11 px-5 gap-11  md:flex-row items-center gap-x-7 bg-[#edf5fa]">
        <h2 className="text-5xl font-bold text-center text-secondary-color md:text-7xl w-full">
          About me
        </h2>
        <p className="shadow-md rounded-lg  bg-white p-5">
