...
export const CustomIcons = {
  roles: {
    ...
    tester: <MdOutlineBugReport size={iconSize} color="#28a745" />, // Icon for Tester/Quality Assurance
    researcher: <FaSearch size={iconSize} color="#dc3545" />, // Icon for Researcher
    devops: <FaServer size={iconSize} color="#f0ad4e" />, // Icon for DevOps Engineer
