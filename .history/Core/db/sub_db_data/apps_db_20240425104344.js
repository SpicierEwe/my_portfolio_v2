...
export const appsDb = [
  {
    ...
    info: `This app is a complete Qur'an app for all the muslims around the world, consting of the majority language translations avaialble, tafseer, 49+ reciters & translators, and much more. All the Qur'anic data is from the authentic source ${embedCustomLinks(
